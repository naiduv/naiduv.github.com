...
(function()
{
	...
	ExpNode.prototype.eval_object_behavior_exp = function (ret)
	{
		...
		// Default to parameter's intended SOL index
		var index = this.owner.solindex;

		// ...unless there is an instance expression, in which case evaluate it
		if (this.instance_expr) {
	...
	ExpNode.prototype.eval_and = function (ret)
	{
		...
		if (ret.is_number())
		{
			// Right operand string: concatenate strings
			if (temp.is_string())
			{
		...
		{
			// Left operand string: perform string concatenation
			if (temp.is_string())
				ret.data += temp.data;
			else
			{
